...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand visible-xs-block visible-sm-block" href="http://www.hakkoblogs.com">Profil</a>
				<a class="navbar-brand hidden-xs hidden-sm" href="http://www.hakkoblogs.com">Profil</a>
			</div>
	...
	<div class="container">
		<div class="content">
			<h2>Biodata Diri &raquo; Ganti Password</h2>
			<hr />
			
			<p>Ganti password profil dengan NIM <?php echo '<b>'.$_GET['nim'].'</b>'; ?></p>
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM profil WHERE nim='$nim' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE profil SET password='$pass' WHERE nim='$nim'");
							if($update){
